...
{
    public sealed class AudioBufferRecorder : IDisposable
    {
        ...
        public AudioBufferRecorder(int maxSeconds = 120)
        {
        ...
        public void BeginRecording()
        {
            if (_disposed)
            {
                throw new ObjectDisposedException(nameof(AudioBufferRecorder));
            }
